...
/// windows.
///
/// This follows `Ghostty.SurfaceView`'s conformance: only the UUID travels on
/// the pasteboard and the receiver looks the tab back up, so nothing about a
/// live terminal has to be serialized.
